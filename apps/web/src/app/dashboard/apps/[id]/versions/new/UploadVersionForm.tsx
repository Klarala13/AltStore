...
// ---------------------------------------------------------------------------
// UploadVersionForm — receives the resolved appId from the server page
// ---------------------------------------------------------------------------

export const UploadVersionForm = ({ appId }: { appId: string }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    await new Promise<void>((resolve) => {
      ...
      xhr.open("POST", `/api/apps/${appId}/versions`);
  ...
  // ---------------------------------------------------------------------------
  // Post-upload scan tracking state
  // ---------------------------------------------------------------------------
  ...
  if (uploadedVersion) {
    return (
      <div className="mx-auto max-w-2xl">
        ...
        <ScanStatus version={uploadedVersion} appId={appId} onDone={(s) => setFinalStatus(s)} />

        {finalStatus && (
          <div className="mt-6 flex gap-3">
            <button
              type="button"
              onClick={() => router.push(`/dashboard/apps/${appId}` as Route)}
