    ...
    <>
      ...
      <section className="px-6 py-12 md:px-16 lg:px-24 xl:px-32">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          <Link
            href="/"
            className="group flex items-center gap-5 rounded-2xl border border-zinc-800 bg-zinc-950 p-6 transition-colors duration-200 hover:border-zinc-600"
          >
            <div
          ...
          {categoriesWithCount.map(({ slug, label, count, icon }) => (
            <Link
              key={slug}
            ...
            >
              <div
                className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-xl transition-colors duration-200"
                style={{
